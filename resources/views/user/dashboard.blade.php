        ...
        <div class="row no-margin">
            <div class="col-md-6">
                <form action="{{url('confirm/ride')}}" method="GET" onkeypress="return disableEnterKey(event);">
                    ...
                    <div class="input-group dash-form">
                        <input type="text" class="form-control" readonly id="estimated_fare" name="estimated_fare"  placeholder="Estimated Fare" >
                    </div>
...
{{--                        <dd><span id="estimated_fare_label"></span></dd>--}}
{{--                    </dl>--}}
...
<script type="text/javascript">
    ...
    <script>
        $(document).ready(function () {
            ...
            $("input[name='service_type']").each(function (i, element) {
                $(element).on('change', function (e) {
                    calculateFare(mapData, $(this).val());
                });
            });

            $(document).on('map_changed', function(e, data){
                mapData = data.map;
                calculateFare(data.map, $("input[name='service_type']:checked", $('#fare-amount')).val());
            })
        })
    </script>
