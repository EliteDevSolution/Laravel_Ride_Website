      ...
      <div class="container">
        ...
        <div class="col-md-12">
            ...
            <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false">
              ...
              <a class="navbar-brand" href="{{url('dashboard')}}">@if(Setting::get('site_logo')!='')
                        <img style="height: 30px; margin-bottom: 15px;" src="{{ Setting::get('site_logo', asset('logo-black.png')) }}">
                        @endif</a>
