...
Route::group(['prefix' => 'admin'], function () {
    Route::get('/test_mail', 'AdminAuth\LoginController@test_mail');
...
Route::get('/ride/fare_estimate', 'RideController@fare_estimate')->name('user.ride.fare_estimate');
...
Route::get('/fare_estimate', 'RideController@fare_estimate_page');
